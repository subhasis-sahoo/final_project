...
?>
  <script>
    ...
    window.location = "download_admit_card.php";
  </script>
<?php
}
...
$studentDetailes = getStudentsDetails_by_sic($sic)->fetch_assoc();
...
<div class="container-fluid mt-3 mx-0 px-4 main-container">
  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      <a href="download_admit_card.php" class="btn btn-sm btn-outline-secondary">
