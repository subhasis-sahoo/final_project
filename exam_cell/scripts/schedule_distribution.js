const scheduleDistributionForm = document.getElementById('scheduleDistributionForm');
...
const scheduleDistributionOverlay = document.getElementById('scheduleDistributionOverlay');


scheduleDistributionForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    // Showing overlay
    scheduleDistributionOverlay.classList.remove('d-none');
    ...
    setTimeout(async function () {
        ...
        // Hide overlay
        scheduleDistributionOverlay.classList.add('d-none');
        ...
        if(!isSomeFieldEmpty) {
            try {
                const response = await fetch("schedule_distribution_data.php", {
                    method: "POST",
                    body: formData
                });
                ...
                console.log("Error while schedule deadline for the admit card distribution: ", error);
            }
        } else {
